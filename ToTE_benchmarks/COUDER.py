...
# python ToTE_benchmarks/COUDER.py --topo_name Facebook_pod_a --TE_solver COUDER --max_ports 16 --base_capacity 3000 --mode test
# python ToTE_benchmarks/COUDER.py --topo_name Facebook_pod_b --TE_solver COUDER --max_ports 16 --base_capacity 5000 --mode test
# python ToTE_benchmarks/COUDER.py --topo_name Topo_16 --TE_solver COUDER --max_ports 32 --base_capacity 5000 --mode test
# python ToTE_benchmarks/COUDER.py --topo_name Random_30 --TE_solver COUDER --max_ports 64 --base_capacity 5000 --mode test
# python ToTE_benchmarks/COUDER.py --topo_name Topo_32 --TE_solver COUDER --max_ports 64 --base_capacity 5000 --mode test
# python ToTE_benchmarks/COUDER.py --topo_name Topo_64 --TE_solver COUDER --max_ports 128 --base_capacity 5000 --mode test
# python ToTE_benchmarks/COUDER.py --topo_name Topo_128 --TE_solver COUDER --max_ports 256 --base_capacity 5000 --mode test
# python ToTE_benchmarks/COUDER.py --topo_name Facebook_rack_a --TE_solver COUDER --max_ports 256 --base_capacity 5000 --mode test