...
def benchmark(props):
    ...
    if props.mode == 'test':
        ...
        if os.path.exists(opt1_path):
            ...
            print(f"Warning: opt1 file not found {opt1_path}; fallback to default opt list")
        ...
        opt_path = os.path.join(project_root, "Data", props.topo_name, "test", '20.opt1')
        # Ensure output dir exists for n_matrix
    ...
    for index in tqdm(range(len(dm_list))):
        ...
        if props.mode == 'train':
            ...
            u_tmp,n_matrix_mcf = algorithm.mcf(props.max_ports, demands)
...
# python To-benchmarks/mmcf.py --topo_name Facebook_pod_a --TE_solver MMCF --max_ports 10 --base_capacity 3000 --mode test
# python ToTE_benchmarks/COUDER.py --topo_name Facebook_pod_b --TE_solver COUDER --max_ports 16 --base_capacity 5000 --mode test
# python ToTE_benchmarks/COUDER.py --topo_name Random_30 --TE_solver COUDER --max_ports 64 --base_capacity 5000 --mode test

# python To-benchmarks/mmcf.py --topo_name Facebook_pod_a --TE_solver MMCF --max_ports 16 --base_capacity 5000 --mode test
# python To-benchmarks/mmcf.py --topo_name Topo_16 --TE_solver MMCF --max_ports 32 --base_capacity 5000 --mode test
# python To-benchmarks/mmcf.py --topo_name Topo_32 --TE_solver MMCF --max_ports 64 --base_capacity 5000 --mode test
# python To-benchmarks/mmcf.py --topo_name Topo_64 --TE_solver MMCF --max_ports 128 --base_capacity 5000 --mode test
# python To-benchmarks/mmcf.py --topo_name Facebook_rack_a --TE_solver MMCF --max_ports 256 --base_capacity 5000 --mode test
# python To-benchmarks/mmcf.py --topo_name Topo_128 --TE_solver MMCF --max_ports 256 --base_capacity 5000 --mode test
# python To-benchmarks/mmcf.py --topo_name Topo_256 --TE_solver MMCF --max_ports 512 --base_capacity 5000 --mode test
# python To-benchmarks/mmcf.py --topo_name Topo_512 --TE_solver MMCF --max_ports 1024 --base_capacity 5000 --mode test