...
def benchmark(props):
    ...
    for index in tqdm(range(len(dm_list))):
        ...
        if props.mode == 'train':
            ...
            u_tmp,n_matrix_mcf = algorithm.milp_d(props.max_ports, demands)
    ...
    if props.mode == 'train':
        ...
        # Note: n_matrix saving is disabled (redundant for test mode)
...
# python To-benchmarks/MILP_d.py --topo_name Facebook_pod_a --TE_solver MILPD --max_ports 16 --base_capacity 5000 --mode test
# python To-benchmarks/MILP_d.py --topo_name Topo_16 --TE_solver MILPD --max_ports 32 --base_capacity 5000 --mode test
# python To-benchmarks/MILP_d.py --topo_name Topo_32 --TE_solver MILPD --max_ports 64 --base_capacity 5000 --mode test
# python To-benchmarks/MILP_d.py --topo_name Topo_64 --TE_solver MILPD --max_ports 128 --base_capacity 5000 --mode test
# python To-benchmarks/MILP_d.py --topo_name Facebook_rack_a --TE_solver MILPD --max_ports 256 --base_capacity 5000 --mode test
# python To-benchmarks/MILP_d.py --topo_name Topo_128 --TE_solver MILPD --max_ports 256 --base_capacity 5000 --mode test
# python To-benchmarks/MILP_d.py --topo_name Topo_256 --TE_solver MILPD --max_ports 512 --base_capacity 5000 --mode test
# python To-benchmarks/MILP_d.py --topo_name Topo_512 --TE_solver MILPD --max_ports 1024 --base_capacity 5000 --mode test