...
def benchmark(props):
    ...
    if props.mode == 'test':
        ...
        opt1_path = os.path.join(project_root, "Data", props.topo_name, "test", '16.opt1')
        opt_list = []
    ...
    for index in tqdm(range(len(dm_list))):
        ...
        if props.mode == 'train':
            ...
            couder_time = time.time() - bg_start
            # print(f"{index},{u_tmp}")
            opts.append(u_tmp)
        else:
            ...
            u_tmp,n_matrix_mcf = algorithm.bg(props.max_ports, demands)
...
# python To-benchmarks/BG.py --topo_name Facebook_pod_a --TE_solver BG --max_ports 16 --base_capacity 5000 --mode test
# python To-benchmarks/BG.py --topo_name Topo_16 --TE_solver BG --max_ports 32 --base_capacity 5000 --mode test
# python To-benchmarks/BG.py --topo_name Topo_32 --TE_solver BG --max_ports 64 --base_capacity 5000 --mode test
# python To-benchmarks/BG.py --topo_name Topo_64 --TE_solver BG --max_ports 128 --base_capacity 5000 --mode test
# python To-benchmarks/BG.py --topo_name Facebook_rack_a --TE_solver BG --max_ports 256 --base_capacity 5000 --mode test
# python To-benchmarks/BG.py --topo_name Topo_128 --TE_solver BG --max_ports 256 --base_capacity 5000 --mode test
# python To-benchmarks/BG.py --topo_name Topo_256 --TE_solver BG --max_ports 512 --base_capacity 5000 --mode test
# python To-benchmarks/BG.py --topo_name Topo_512 --TE_solver BG --max_ports 1024 --base_capacity 5000 --mode test

# python To-benchmarks/BG.py --topo_name Facebook_pod_a --TE_solver BG.py --max_ports 16 --base_capacity 3000 --mode test
